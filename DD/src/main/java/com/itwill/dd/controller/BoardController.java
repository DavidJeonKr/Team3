...
public class BoardController {
	...
	public void insert(HttpSession session, Model model, String userid) {
	...
	public void detail(HttpSession session,int bno, Model model, String userid) {
	...
	public void update(HttpSession session,int bno, Model model, String userid) {
	...
	public String search(HttpSession session,String userid, int type, String keyword, Model model) {
